#!/usr/bin/env python3
"""
Enhanced Bali et al. 2012 Model Dashboard v3
...
Usage: streamlit run enhanced_dashboard_v3.py
"""
...
pressure_bar = 26100  # Fixed pressure as requested
...
st.markdown("**Dashboard v3:** Enhanced implementation with selectable salinities • Fixed axis ranges • DM & PM compositions only")
